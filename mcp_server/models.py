...
class CertificateParameters(BaseModel):
    DocumentNumber: str = Field(
        ..., description='Document Number', examples=['123456789']
    )
...
class ApmclCertificatePostRequest(BaseModel):
...
class ApmclCertificatePostResponse(BaseModel):
...
class ApmclCertificatePostResponse1(BaseModel):
...
class ApmclCertificatePostResponse2(BaseModel):
...
class ApmclCertificatePostResponse3(BaseModel):
...
class ApmclCertificatePostResponse4(BaseModel):
...
class ApmclCertificatePostResponse5(BaseModel):
...
class ApmclCertificatePostResponse6(BaseModel):
